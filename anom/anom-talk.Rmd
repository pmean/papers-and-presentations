...
A laboratory was studying hardness measures of some materials (arbirarily labelled A, B, C, and D) by compressing them until they break. The researchers measured strength for 6 different pieces of each material, for a total of 24 measurements.
...
### Piston ring, descriptive statistics.
...
mean_diameter <- apply(diameter, 1, mean)
std_diameter <- apply(diameter, 1, sd)
data.frame(
  Day=1:40, 
  Mean_diameter=mean_diameter, 
  Stdev_diameter=std_diameter) %>%
  kbl %>%
...
This slide shows an example of a control chart for means.You plot the individual means over 40 consecutive days.
