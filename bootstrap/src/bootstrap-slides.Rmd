...
+ $\bar{X}$ is approximately normal
  + Even if the individual values are not normal
...
Note that $\bar{X}=`r x0`$.

$\ $

$\frac{1}{5}(|`r x[1]`-`r x0`|+|`r x[2]`-`r x0`|+|`r x[3]`-`r x0`|+|`r x[4]`-`r x0`|+|`r x[5]`-`r x0`|)$ 

$\ $

$\frac{1}{5}(`r abs(x[1]-x0)`+`r abs(x[2]-x0)`+`r abs(x[3]-x0)`+`r abs(x[4]-x0)`+`r abs(x[5]-x0)`)$ 
...
Calculate $MAD$ (`r paste(x[-1], sep=",")`) = `r m1` 

Note that mean (`r paste(x[-1], sep=",")`) = `r x1`

$\frac{1}{4}(|`r x[2]`-`r x1`|+|`r x[3]`-`r x1`|+|`r x[4]`-`r x1`|+|`r x[5]`-`r x1`|)$. 

$\ $

$\frac{1}{5}(`r abs(x[2]-x1)`+`r abs(x[3]-x1)`+`r abs(x[4]-x1)`+`r abs(x[5]-x1)`)$ 
